...
if len(sys.argv) != 4:
    ...
    print("1:cuda_num, 2:model_name, 3:sentence_length")
    sys.exit(1)

cuda_num = sys.argv[1]
if sys.argv[1].isdigit() == False or sys.argv[3].isdigit() == False:
...
inputs, masks, _ = make_bert_inputs(
    path="../data/REST_test_x.csv", sentence_length=int(sentence_len), config=("./tokenizer" + sentence_len))
